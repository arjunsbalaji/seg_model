...
class Train(object):
    def __init__(self, args, run_name):
        ...
        if args['location'] == 'home':    
            ...
            self.main_data_dir = '/media/arjun/VascLab EVO/projects/oct_ca_seg/actual final data'
            self.save_spot = os.path.join('/media/arjun/VascLab EVO/projects/oct_ca_seg/runsaves', run_name)
        elif args['location'] == 'pawsey':    
            self.main_data_dir = '/scratch/pawsey0271/abalaji/projects/oct_ca_seg/actual final data'
